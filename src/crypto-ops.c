...
void ge_double_scalarmult_precomp_vartime_p3(ge_p3 *r, const unsigned char *a, const ge_p3 *A, const unsigned char *b,
                                             const ge_dsmp Bi)
{
    ge_dsmp Ai; /* A, 3A, 5A, 7A, 9A, 11A, 13A, 15A */
...
void ge_double_scalarmult_precomp_vartime2_p3(ge_p3 *r3, const unsigned char *a, const ge_dsmp Ai,
...
void sc_reduce32copy(unsigned char *scopy, const unsigned char *s)
{
    ...
    scopy[0] = (unsigned char)(s0 >> 0);
    scopy[1] = (unsigned char)(s0 >> 8);
    scopy[2] = (unsigned char)((s0 >> 16) | (s1 << 5));
    scopy[3] = (unsigned char)(s1 >> 3);
    scopy[4] = (unsigned char)(s1 >> 11);
    scopy[5] = (unsigned char)((s1 >> 19) | (s2 << 2));
    scopy[6] = (unsigned char)(s2 >> 6);
    scopy[7] = (unsigned char)((s2 >> 14) | (s3 << 7));
    scopy[8] = (unsigned char)(s3 >> 1);
    scopy[9] = (unsigned char)(s3 >> 9);
    scopy[10] = (unsigned char)((s3 >> 17) | (s4 << 4));
    scopy[11] = (unsigned char)(s4 >> 4);
    scopy[12] = (unsigned char)(s4 >> 12);
    scopy[13] = (unsigned char)((s4 >> 20) | (s5 << 1));
    scopy[14] = (unsigned char)(s5 >> 7);
    scopy[15] = (unsigned char)((s5 >> 15) | (s6 << 6));
    scopy[16] = (unsigned char)(s6 >> 2);
    scopy[17] = (unsigned char)(s6 >> 10);
    scopy[18] = (unsigned char)((s6 >> 18) | (s7 << 3));
    scopy[19] = (unsigned char)(s7 >> 5);
    scopy[20] = (unsigned char)(s7 >> 13);
    scopy[21] = (unsigned char)(s8 >> 0);
    scopy[22] = (unsigned char)(s8 >> 8);
    scopy[23] = (unsigned char)((s8 >> 16) | (s9 << 5));
    scopy[24] = (unsigned char)(s9 >> 3);
    scopy[25] = (unsigned char)(s9 >> 11);
    scopy[26] = (unsigned char)((s9 >> 19) | (s10 << 2));
    scopy[27] = (unsigned char)(s10 >> 6);
    scopy[28] = (unsigned char)((s10 >> 14) | (s11 << 7));
    scopy[29] = (unsigned char)(s11 >> 1);
    scopy[30] = (unsigned char)(s11 >> 9);
    scopy[31] = (unsigned char)(s11 >> 17);
}
