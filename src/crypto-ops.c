...
void ge_double_scalarmult_precomp_vartime_p3(ge_p3 * r, const unsigned char *a,
                                           const ge_p3 * A,
                                           const unsigned char *b,
                                           const ge_dsmp Bi)
{
...
void sc_mul(unsigned char *s, const unsigned char *a, const unsigned char *b)
{
  ...
  s9 =
    (a0 * b9 + a1 * b8 + a2 * b7 + a3 * b6 + a4 * b5 + a5 * b4 + a6 * b3 +
     a7 * b2 + a8 * b1 + a9 * b0);
  s10 =
    (a0 * b10 + a1 * b9 + a2 * b8 + a3 * b7 + a4 * b6 + a5 * b5 + a6 * b4 +
     a7 * b3 + a8 * b2 + a9 * b1 + a10 * b0);
  s11 =
    (a0 * b11 + a1 * b10 + a2 * b9 + a3 * b8 + a4 * b7 + a5 * b6 + a6 * b5 +
  ...
  s13 =
    (a2 * b11 + a3 * b10 + a4 * b9 + a5 * b8 + a6 * b7 + a7 * b6 + a8 * b5 +
     a9 * b4 + a10 * b3 + a11 * b2);
  s14 =
    (a3 * b11 + a4 * b10 + a5 * b9 + a6 * b8 + a7 * b7 + a8 * b6 + a9 * b5 +
     a10 * b4 + a11 * b3);
  s15 =
    (a4 * b11 + a5 * b10 + a6 * b9 + a7 * b8 + a8 * b7 + a9 * b6 + a10 * b5 +
     a11 * b4);
  s16 =
