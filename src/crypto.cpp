...
void crypto_ops::scReduce32(EllipticCurveScalar &scalar) { sc_reduce32(reinterpret_cast<unsigned char *>(&scalar)); }
...
bool crypto_ops::generateRingSignatures(const Hash prefixHash, const KeyImage keyImage,
