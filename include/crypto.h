...
class crypto_ops
{
  ...
  public:
    static bool generateRingSignatures(const Hash prefixHash, const KeyImage keyImage,
 ...
 */
template <typename T> typename std::enable_if<std::is_pod<T>::value, T>::type rand()
{
...
/* Generate a new key pair */ inline void generate_keys(PublicKey &pub, SecretKey &sec)
{
...
inline void scReduce32(EllipticCurveScalar &data) { crypto_ops::scReduce32(data); }
